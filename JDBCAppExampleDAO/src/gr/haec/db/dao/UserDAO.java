...
public class UserDAO extends BaseDAO<User> {
	...
	public UserDAO(Connection conn) throws SQLException {
		...
		selectByIdStatement = dbConnection
				.prepareStatement("SELECT id, user_login, user_pass, user_email, user_registered FROM wp_users WHERE id = ?;");
		selectAllStatement = dbConnection.prepareStatement("SELECT id, user_login, user_pass, user_email, user_registered FROM wp_users;");
